...
# TODO : Need package structure to remove relative imports
import sys
sys.path.append('../simulation/')
from sim import Simulator as cppSim

RESULTS_ROOT_FOLDER = os.path.realpath(os.path.join(os.path.abspath(__file__), '../../../../results'))
CONFIG_FILE = os.path.realpath(os.path.join(os.path.abspath(__file__), '../../../../params.yaml'))
