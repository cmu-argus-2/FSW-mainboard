...
@pytest.mark.parametrize(
    "val, expected",
    [
        (32767.9999, [0x7F, 0xFF, 0xFF, 0xF9]),
        (-32767.9999, [0xFF, 0xFF, 0xFF, 0xF9]),
        (0.5, [0x00, 0x00, 0x80, 0x00]),
        (-0.5, [0x80, 0x00, 0x80, 0x00]),
        (12345.6789, [0x30, 0x39, 0xAD, 0xCC]),
    ],
)
...
@pytest.mark.parametrize(
    "val, expected",
    [
        (128.9999999, [0x00, 0xFF, 0xFF, 0xFE]),
        (-128.9999999, [0x80, 0xFF, 0xFF, 0xFE]),
        (0.5, [0x00, 0x80, 0x00, 0x00]),
        (-0.5, [0x80, 0x80, 0x00, 0x00]),
        (12.3456789, [0x0C, 0x58, 0x7E, 0x69]),
    ],
)
