...
class Task(TemplateTask):
    ...
    def log_fuel_gauge_readings(self):
        self.log_debug(f"Battery Pack Temperature AIN1: {self.log_data[EPS_IDX.BATTERY_PACK_TEMPERATURE_AIN1]} cC")
        self.log_debug(f"Battery Pack Temperature AIN2: {self.log_data[EPS_IDX.BATTERY_PACK_TEMPERATURE_AIN2]} cC")
        self.log_debug(f"Battery Pack Temperature Die: {self.log_data[EPS_IDX.BATTERY_PACK_TEMPERATURE_DIE]} cC")
