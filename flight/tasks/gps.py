...
class Task(TemplateTask):
    ...
    async def main_task(self):
        ...
        if SM.current_state == STATES.STARTUP:
            ...
            self.log_data[GPS_IDX.GPS_ECEF_X] = 0
            self.log_data[GPS_IDX.GPS_ECEF_Y] = 0
            self.log_data[GPS_IDX.GPS_ECEF_Z] = 0
            self.log_data[GPS_IDX.GPS_ECEF_VX] = 0
            self.log_data[GPS_IDX.GPS_ECEF_VY] = 0
            self.log_data[GPS_IDX.GPS_ECEF_VZ] = 0
