...
class ADCS_IDX:
    ...
    LIGHT_SENSOR_ZP_YP = const(18)
    LIGHT_SENSOR_ZP_XM = const(19)
    LIGHT_SENSOR_ZP_YM = const(20)
...
class HAL_IDX:
    ...
    LIGHT_ZP_YP_ERROR = const(61)
    LIGHT_ZP_YP_ERROR_COUNT = const(62)
    LIGHT_ZP_XM_ERROR = const(63)
    LIGHT_ZP_XM_ERROR_COUNT = const(64)
    LIGHT_ZP_YM_ERROR = const(65)
    LIGHT_ZP_YM_ERROR_COUNT = const(66)
