...
class DataProcess:
    ...
    def create_new_path(self) -> str:
        ...
        return join_path(self.dir_path, self.tag_name) + "_" + str(int(TimeProcessor.time())) + ".bin"
...
class ImageProcess(DataProcess):
    ...
    def create_new_path(self) -> str:
        ...
        return join_path(self.dir_path, self.tag_name) + "_" + str(int(TimeProcessor.time())) + ".jpg"
