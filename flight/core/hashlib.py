...
"""
Ported from Adafruit_CircuitPython_hashlib
...
# FIPS secure hash algorithms implemented in this file for this platform
ALGOS_AVAIL = ["sha224", "sha256"]


def new(algo, data: Optional[bytes] = b""):
