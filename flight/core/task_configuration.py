...
TASK_CONFIG = {
    TASK.COMMAND: {"Task": command, "Frequency": 2, "Priority": 3},
    TASK.WATCHDOG: {"Task": watchdog, "Frequency": 1, "Priority": 1},
    TASK.EPS: {"Task": eps, "Frequency": 5, "Priority": 3},
    TASK.OBDH: {"Task": obdh, "Frequency": 0.5, "Priority": 3},
    TASK.COMMS: {"Task": comms, "Frequency": 1, "Priority": 3, "ScheduleLater": True},
    TASK.ADCS: {"Task": adcs, "Frequency": 5, "Priority": 2},
    TASK.GPS: {"Task": gps, "Frequency": 0.025, "Priority": 4, "ScheduleLater": True},
    ...
    TASK.HAL_MONITOR: {"Task": hal_monitor, "Frequency": 5, "Priority": 3},
}
