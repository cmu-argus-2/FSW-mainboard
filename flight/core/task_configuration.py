...
TASK_CONFIG = {
    TASK.COMMAND: {"Task": command, "Frequency": 1, "Priority": 1},
    TASK.WATCHDOG: {"Task": watchdog, "Frequency": 0.5, "Priority": 1},
    TASK.EPS: {"Task": eps, "Frequency": 0.5, "Priority": 1},
    ...
    TASK.GPS: {"Task": gps, "Frequency": 0.1, "Priority": 2, "ScheduleLater": True},
