...
class HAL_IDX:
    ...
    LIGHT_ZP_1_ERROR = const(85)
    LIGHT_ZP_1_ERROR_COUNT = const(86)
    LIGHT_ZP_1_DEAD = const(87)
    LIGHT_ZP_2_ERROR = const(88)
    LIGHT_ZP_2_ERROR_COUNT = const(89)
    LIGHT_ZP_2_DEAD = const(90)
    LIGHT_ZP_3_ERROR = const(91)
    LIGHT_ZP_3_ERROR_COUNT = const(92)
    LIGHT_ZP_3_DEAD = const(93)
